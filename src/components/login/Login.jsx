    ...
    const handleSubmit = (event) => {
        ...
        if(tempArr.length !== 0){
            ...
            if(isUserExist){
                ...
                sessionStorage.setItem("loggedin-user", data.username);
                setTimeout(() => {
                    navigate("/task")
                }, 2000);
            } else{
            ...
            toast.error(`Please register to login`, {position: 'top-right'})
        }
    }
                ...
                <div className='w-1/2 bg-white rounded-md p-3'>
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className='mb-2'>
                            ...
                            <input type="text" name="username" placeholder='Enter Username' required autoComplete='off' maxLength={20}
                        ...
                        <div className='mb-2'>
                            ...
                            <div className='flex relative justify-end items-center'>
                                ...
                                className='w-full px-3 py-2 border-2 rounded-md mt-1' maxLength={20} onChange={(e) => handleInput(e)} />
                                {
                        ...
                        <button className='text-md text-white font-semibold bg-green-700 px-8 py-2 rounded-md hover:bg-green-900 mt-2'>Login</button>
                    </form>
                    <p className='font-medium pt-1'>Don't have an account? Please <Link to='/register' className='text-blue-500 hover:text-blue-700'>Register Here</Link></p>
                </div>
            </div>
        </>
    )
